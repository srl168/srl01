...
// ==========================================
// 💡 3️⃣ 純硬體雙音對照組直通網路（控制台 0 警告、0 雜音）
// ==========================================
...
window.globalRenderLoop = function() {
    ...
    window.fCtx.strokeStyle = 'rgba(255, 255, 255, 0.12)'; window.fCtx.lineWidth = 1; window.fCtx.setLineDash([4, 4]);
